...
const Reviews = (props: Props) => {
    ...
    // функция onSend обрабатывает событие отправки формы и выполняет следующие действия:

    // (e: React.FormEvent<HTMLFormElement>) - указывает на тип события отправки формы (FormEvent<HTMLFormElement>) и принимает его в качестве аргумента.
    // e.preventDefault() - предотвращает стандартное поведение отправки формы, чтобы страница не перезагружалась.
